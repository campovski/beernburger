...
with open("tmp/beers.txt", "r") as fin:
    for line in fin:
        ...
        if line[0] == "#" and line[1] == "#":
            ...
            review["review"] = line[1:].strip()
        elif line[0] == "-":
            review["image"] = line[1:].strip()
        elif line.strip() != "":
